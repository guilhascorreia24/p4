...
struct Point *letra_goncalo()
{
    ...
    size_g = sizeof(letra_g) / sizeof(float);
    for (int i = 0; i < totalVertices * 3; i += 6)
    {
        ...
        letra_g[i + 0] = letra_g[i + 0] * 0.75;
        letra_g[i + 1] = letra_g[i + 1] * 0.75; //scale X0.75
